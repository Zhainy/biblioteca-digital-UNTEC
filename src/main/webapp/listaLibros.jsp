...
<head>
    ...
    <style>
        ...
        .navbar { background-color: #0d3b66 !important; }
...
<div class="container">
    <div class="row mb-4">
        <div class="col">
            ...
            <p class="text-muted">Gestione los préstamos y devoluciones online[cite: 9, 12].</p>
        </div>
        <div class="col text-end">
            <button class="btn btn-success"><i class="bi bi-plus-lg me-1"></i> Nuevo Libro</button>
        </div>
    </div>
                    ...
                    <c:forEach items="${listaLibros}" var="libro">
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-sm btn-outline-dark" title="Editar"><i class="bi bi-pencil"></i></button>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
